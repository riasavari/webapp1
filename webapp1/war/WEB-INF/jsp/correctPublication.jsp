...
<html>
	...
	<body>
      ...
      <h3 class="form-heading">Correct Publication Details</h3>
    <div class="jumbotron">
	<form  method="get"  class="fillform form-horizontal" name="formPubCorrection" action="correct">
	
	<div class="form-group">
      <input type="text" class="form-control" name="pubno" id="pubno" placeholder="Enter publication number (e.g: 2 not 0002)">
    </div>
	
      
      
       <button type="submit" class="myButton" id="btn-getpubdetails" >Get</button>
			 <!--  </div> -->
